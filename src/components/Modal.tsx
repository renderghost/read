      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-6xl max-h-[90vh] overflow-y-auto bg-bones-white dark:bg-bones-dimgray rounded shadow-xl"
            ref={contentRef}
          >
        <button
          ref={closeButtonRef}
        ...
        <div id="modal-title" className="sr-only">{book.title}</div>
